...
public class Homer {
  ...
  private UltrasonicSensor range = new UltrasonicSensor(SensorPort.S3);
...
//        new Line(132, 294, 132, 0), new Line(132, 0, 32, 0)
  ...
  public Homer()
  {
        ...
        try {
            ...
            float wheelDiameter = Float.parseFloat(pp.getProperty(PilotProps.KEY_WHEELDIAMETER, "3.4"));
            float trackWidth = Float.parseFloat(pp.getProperty(PilotProps.KEY_TRACKWIDTH, "13"));
